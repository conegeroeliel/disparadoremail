...
export function EmailComposer({ 
  ...
  const { saveEmailList, emailLists, loadEmailList } = useEmailLists()
  ...
  const handleSelectList = (listId: string) => {
    ...
    if (listId && listId !== "none") {
      const list = loadEmailList(listId)
      if (list) {
  ...
  const handleDownloadHTML = () => {
    ...
    toast({
      title: "HTML baixado",
      description: "Template HTML foi salvo no seu computador.",
    })
  }

  return (
    <div className="space-y-6 h-[calc(100vh-120px)]">
      {/* Seção de Configurações no Topo */}
      <Card>
        <CardHeader>
        ...
        <CardContent className="space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            {/* Assunto */}
            <div className="space-y-4">
              <h3 className="text-lg font-semibold">Assunto</h3>
              <div className="space-y-2">
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-3">
                ...
                {emailLists.length > 0 && (
                  <div className="space-y-2">
                    <Label htmlFor="list-selector">Selecionar Lista Salva</Label>
                ...
                <div className="space-y-2">
                  <Label htmlFor="file-upload">Upload de Lista</Label>
                ...
                <div className="space-y-2">
                  <Label htmlFor="to">Adicionar E-mail</Label>
              ...
              <div className="space-y-3">
                {emailList.length > 0 && (
                  <div className="flex items-center gap-2">
                    ...
                    {failedEmails.some(email => emailList.includes(email)) && (
                      <Button
                        variant="outline"
                        size="sm"
                ...
                <div className="text-sm text-gray-600">
                  <strong>{emailList.length}</strong> destinatários
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="flex gap-3">
            {isLoading ? (
              ...
              <>
                <Button
                  onClick={handleSend}
                  disabled={emailList.length === 0 || !htmlContent.trim()}
              ...
              {htmlContent ? (
                ...
                <div className="h-full flex items-center justify-center text-gray-500">
                  <div className="text-center">
                    ...
                    <p>Digite HTML no editor para ver o preview</p>
                  </div>
                </div>
              )}
            </div>
